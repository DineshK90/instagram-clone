...
<br />
<br />
<span className='me-4'><strong>{posts_no}</strong> posts</span>
<span className='me-4'><strong>{followers}</strong> followers</span>
<span className='me-4'><strong>{following}</strong> following</span>
